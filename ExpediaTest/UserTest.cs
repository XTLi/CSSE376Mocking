...
.SetValue(serviceLocator, serviceLocator);
        ...
        public void TestThatUserDoesRemoveFlightFromServiceLocatorWhenBooked()
        {
            ...
            var flightToBook = new Flight(new DateTime(2015, 3, 1), new DateTime(2015, 3, 30), 500);
            var remainingFlight = new Flight(new DateTime(2015, 3, 10), new DateTime(2015, 3, 20),800);
